...
import com.junjunlei.gmall.vo.product.PmsBrandParam;
...
@CrossOrigin
@RestController
@Api(tags = SwaggerApiConfig.PMS_BRAND_CONTROLLER)
...
public class PmsBrandController {
    ...
    public Object getBrandList(@RequestParam(value = "keyword", required = false) String keyword,
        ...
        CommonResult commonResult = new CommonResult();
        PageInfoVO pageInfoVO=brandService.getBrandList(keyword,pageNum,pageSize);
